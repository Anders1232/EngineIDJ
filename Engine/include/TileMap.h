...
class TileMap{
	public:
		...
		*/
		void Render(int cameraX=0, int cameraY=0, bool parallax= false, Vec2 mouse= Vec2(-1, -1)) const;
		/**
		...
		*/
		void RenderLayer(int layer, int cameraX=0, int cameraY=0, bool parallax= false, Vec2 mouse= Vec2(-1, -1)) const;
		/**
