...
#define ENEMY_MOVE_SPEED (14000.)
#define ENEMY_HOSTILE_MOVE_SPEED (20000.)
#define ENEMY_QUIMIC_MOVE_SPEED (15000.)
#define ENEMY_ENGINEER_MOVE_SPEED (15000.)
#define ENEMY_ARQUITECT_MOVE_SPEED (19000.)
#define ENEMY_ART_MOVE_SPEED (14000.)
